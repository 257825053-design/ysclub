<h1 align="center">
  ...
  <br>
  Continuation of <a href="https://github.com/zzzgydi/clash-verge">YSCLUB</a>
  <br>
</h1>
...
🎁 Register via the **YSCLUB exclusive invitation link** to receive **3 days of free trial**, with **1GB traffic per day**: 👉 [Register here](https://verge.dginv.click/#/register?code=oaxsAGo6)
...
- 🧑‍💻 **12-hour live customer support** (also assists with YSCLUB usage issues)
...
- ⚡ The world’s first **QUIC-protocol-based proxy service**, now featuring faster **QUIC-family protocols** (best paired with the YSCLUB client)
...
[Support YSCLUB development](https://github.com/sponsors/clash-verge-rev)
...
YSCLUB builds on or draws inspiration from these projects:
