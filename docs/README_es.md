<h1 align="center">
  ...
  <br>
  Continuación de <a href="https://github.com/zzzgydi/clash-verge">YSCLUB</a>
  <br>
</h1>
...
- Regístrate mediante el enlace exclusivo de YSCLUB y obtén una prueba de 3 días con 1 GB de tráfico diario: [Regístrate](https://verge.dginv.click/#/register?code=oaxsAGo6)
- Cupón exclusivo de 20% de descuento para usuarios de YSCLUB: `verge20` (limitado a 500 usos)
...
- Primer proveedor global con **protocolo QUIC**, ahora con protocolos de la familia QUIC más rápidos (ideal para el cliente YSCLUB)
...
[Apoya el desarrollo de YSCLUB](https://github.com/sponsors/clash-verge-rev)
...
YSCLUB se basa en, o se inspira en, los siguientes proyectos:
